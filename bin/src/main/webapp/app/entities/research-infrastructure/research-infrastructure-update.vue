        ...
        <div class="col-12">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                ...
                <b-form-row>
					<b-col sm="3">
                        <div class="form-group" v-if="currentLanguage === 'sr' || currentLanguage === 'en'">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.nameSr')" for="research-infrastructure-nameSr">Name Sr</label>
                    ...
                    <b-col sm="3">
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.nameEn')" for="research-infrastructure-nameEn">Name En</label>
                    ...
                    <b-col sm="3">                        
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.accessType')" for="research-infrastructure-accessType">Access Type</label>
                    ...
                    <b-col sm="3">                        
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.category')" for="research-infrastructure-category">Category</label>
                ...
                <b-form-row>                    
                    <b-col sm="3">
                        <div class="form-group" v-if="currentLanguage === 'sr' || currentLanguage === 'en'">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.keywords')" for="research-infrastructure-keywords">Keywords</label>
                    ...
                    <b-col sm="3">
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.keywordsEn')" for="research-infrastructure-keywords">Keywords</label>
                    ...
                    <b-col sm="3">
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.departmentName')" for="research-infrastructure-departmentName">Department Name</label>
                  ...
                  <b-form-row>
                    ...
                    <b-col sm="3">
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.riWebsite')" for="research-infrastructure-riWebsite">Ri Website</label>
                    ...
                    <b-col sm="3">
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.status')" for="research-infrastructure-status">Status</label>
                    ...
                    <b-col sm="3">
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.accessMode')" for="research-infrastructure-accessMode">Access Mode</label>
                ...
                <b-form-row>
                    ...
                    <b-col sm="3">
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.financeSource')" for="research-infrastructure-financeSource"></label>
                ...
                <b-form-row>                    
                    <b-col sm="3">
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.projectName')" for="research-infrastructure-projectName"></label>
 ...
 <div class="border border-primary" style="padding:35px;margin:20px;">
	 ...
	 <h5 v-text="$t('riportalApp.researchInfrastructure.titleadditionalcomment')">Osnovni podaci</h5>
                ...
                <b-form-row>
					   <b-col sm="3">
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.userManualLinkEn')" for="research-infrastructure-userManualLinkEn">User Manual Link En</label>
					...
					<b-col sm="3">
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.userManualLinkSr')" for="research-infrastructure-userManualLinkSr">User Manual Link Sr</label>
                    ...
                    <b-col sm="3">
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.technicalSpecificationLinkSr')" for="research-infrastructure-technicalSpecificationLinkSr">Technical Specification Link Sr</label>
                    ...
                    <b-col sm="3">
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.technicalSpecificationLinkEn')" for="research-infrastructure-technicalSpecificationLinkEn">Technical Specification Link En</label>
                ...
                <b-form-row>
                 <b-col sm="3">
                    ...
                    <b-col sm="6">
                        <b-row>
                            <b-col sm="12">
                                <label class="form-control-label" v-text="$t('riportalApp.researchInfrastructure.images')"></label>
                                <b-form-file style="margin-bottom:30px"
                                    v-model="imageFiles"                            
