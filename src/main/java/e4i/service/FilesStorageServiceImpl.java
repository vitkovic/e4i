...
public class FilesStorageServiceImpl implements FilesStorageService {
  ...
  public void init() {
    try {
    	this.root = this.byGetResource(e4i.E4i.class);
  ...
  public String getE4iPath() {
	  CodeSource codeSource = e4i.E4i.class.getProtectionDomain().getCodeSource();	 
	  File jarFile;
	try {
		//jarFile = new File(codeSource.getLocation().getPath());
		System.out.println("protection domain = " + e4i.E4i.class.getProtectionDomain());
		System.out.println("code source = " + e4i.E4i.class.getProtectionDomain().getCodeSource());
		System.out.println("location = " + e4i.E4i.class.getProtectionDomain().getCodeSource().getLocation());
		
		
		System.out.println("toUri = " + e4i.E4i.class.getProtectionDomain().getCodeSource().getLocation().toURI());
		System.out.println("path = " + e4i.E4i.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
		String jarPath = e4i.E4i.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath();
