...
public class UserService {
    ...
    public UserService(UserRepository userRepository, PortalUserRepository portalUserRepository, PasswordEncoder passwordEncoder, AuthorityRepository authorityRepository, CacheManager cacheManager) {
