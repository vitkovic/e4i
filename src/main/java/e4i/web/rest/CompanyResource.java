...
public class CompanyResource {
    ...
    @Transactional
    public ResponseEntity<Company> updateCompanyCreatedBy(@PathVariable Long companyId, @PathVariable Long userId) throws URISyntaxException {
...
//   	  	portalUser.setCompanyCreateds(allCompanyCreateds);
    ...
    @Transactional
    public ResponseEntity<Company> updateCompanyModifiedBy(@PathVariable Long companyId, @PathVariable Long userId) throws URISyntaxException {
        log.debug("REST request to update Company : {}", companyId);
