...
public interface RequestForServiceRepository extends JpaRepository<RequestForService, Long> {	
    ...
    Page<RequestForService> findByUsersId(Long usersId, Pageable pageable);
    
    List<RequestForService> findByServicesIdAndUsersId(Long servicesId, Long usersId);
    
    List<RequestForService> findByServicesIdAndUsersIdAndStateId(Long servicesId, Long usersId, Long stateId);
    ...
    Page<RequestForService> findByUsersIdAndEndTimeBefore(Long usersId,ZonedDateTime date, Pageable pageable);
